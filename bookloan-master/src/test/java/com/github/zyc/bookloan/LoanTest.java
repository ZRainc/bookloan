package com.github.zyc.bookloan;
...
public class LoanTest {
    ...
    public void generateData(){
        logger.info("初始化数据");
        //构造人员
        member1=new Member(9143690,"jia",new ArrayList<Loan>());
        member2=new Member(9143691,"yi",new ArrayList<Loan>());
        member3=new Member(9143692,"bing",new ArrayList<Loan>());
        //构造书籍
        book1=new Book(1,"0001","数据结构(副本1)",member3);
        book2=new Book(2,"0001","数据结构(副本2)",null);
        book3=new Book(3,"0001","数据结构(副本3)",member1);

        book4=new Book(4,"0002","操作系统(副本1)",member2);
        book5=new Book(5,"0002","操作系统(副本2)",null);
        book6=new Book(6,"0002","操作系统(副本3)",member1);

        book7=new Book(7,"0003","软件工程(副本1)",member2);
        book8=new Book(8,"0003","软件工程(副本2)",null);
        book9=new Book(9,"0003","软件工程(副本3)",member1);
    ...
    public void loanBook(){
        ...
        //甲不可借：已经借满三本
        logger.info("");
        logger.info("甲申请借书："+member1.toString());
        member1.getLoans().stream().forEach(loan -> {
            logger.info("甲借书历史："+loan.toString());
        });
        ...
        //乙不可借：不可借同一本书
        logger.info("");
        logger.info("乙申请借书："+member2.toString());
        member2.getLoans().stream().forEach(loan -> {
            logger.info("乙借书历史："+loan.toString());
        });
        ...
        //丙借书
        logger.info("");
        logger.info("丙申请借书："+member3.toString());
        member3.getLoans().stream().forEach(loan -> {
            logger.info("丙借书历史："+loan.toString());
        });
        logger.info("所借书籍："+book5);
        ...
        //丙还书
        logger.info("");
        logger.info("丙还书："+member3.toString());
        member3.getLoans().stream().forEach(loan -> {
            logger.info("丙借书历史："+loan.toString());
        });
